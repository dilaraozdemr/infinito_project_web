...
class ProjectDetailHomeDesktop extends StatefulWidget {
  final String id;
  const ProjectDetailHomeDesktop({Key? key, required this.id}) : super(key: key);

  @override
  State<ProjectDetailHomeDesktop> createState() => _ProjectDetailHomeDesktopState();
}

class _ProjectDetailHomeDesktopState extends State<ProjectDetailHomeDesktop> {
